  ...
  return (
    <div className="bg-[#F8FAFC] dark:bg-[#050505] min-h-screen text-[#0F172A] dark:text-white pt-28 pb-20 font-sans transition-colors duration-300">
      <SEO 
        ...
        description="Explore ATIDETO Technologies software development services and student internship hubs across 29 cities in Tamil Nadu, including Salem, Chennai, Coimbatore, and Madurai."
        url="https://www.atideto.in/locations"
        schema={schema}
      />
      ...
      <section className="px-6 lg:px-16 max-w-7xl mx-auto text-center mb-16">
        ...
        <p className="text-[#64748B] dark:text-[#94A3B8] text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
          From our engineering headquarters in Salem, we provide enterprise software development, generative AI automation, and tech academy internships to businesses and students across 29 districts.
        </p>
      </section>
