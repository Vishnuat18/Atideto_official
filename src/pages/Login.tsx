        ...
        <div className="w-full max-w-md space-y-5 my-auto">
          ...
          <div className="text-center mb-6">
            <div className="flex justify-center items-center gap-3 mb-4">
              <img src={atidetoLogo} alt="Atideto Logo" className="h-10 w-auto object-contain filter drop-shadow-[0_0_12px_rgba(46,168,255,0.5)]" />
              <span className="text-2xl sm:text-3xl font-extrabold font-montserrat tracking-tight text-white">Atideto</span>
            </div>
            ...
            <p className="text-[#AFAFAF] text-sm">
              {mode === 'login' 
                ...
                : 'Join Atideto and start your learning journey'}
            </p>
          </div>
