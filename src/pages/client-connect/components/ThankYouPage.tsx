  ...
  return (
    <div className="w-full flex flex-col items-center justify-center text-center">
      ...
      <div className="cc-success-actions">
        <button onClick={handleDownloadSummary} className="btn2 outline">
          <Download /> Download Request Summary
        </button>

        <button onClick={() => navigate('/')} className="btn2 outline">
          <Home /> Return Home
        </button>

        <button onClick={onReset} className="btn2 grad">
          <PlusCircle /> Book Another Project
        </button>
      </div>
    </div>
  );
