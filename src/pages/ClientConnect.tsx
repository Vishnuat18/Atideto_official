...
export default function ClientConnect() {
  ...
  return (
    <div className="contact-page relative text-[color:var(--cc-white)] overflow-x-hidden">
      <SEO
        title="Start a Project & Enterprise Consultation | ATIDETO Technologies"
        description="Connect with ATIDETO Technologies for business solutions (CRM, ERP, Billing, Inventory), custom software, mobile apps, and AI automation. Fast turnaround & transparent delivery in Salem, Tamil Nadu, and worldwide."
        keywords="Start project ATIDETO, ATIDETO Technologies contact, software consultation Salem, custom ERP quote, hire software developers Tamil Nadu, ATIDETO business solutions inquiry, AI agency India"
          ...
          "@graph": [
            {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "Client Connect & Start a Project", "item": "https://www.atideto.in/client-connect" }
              ]
            },
            {
              "@type": "ContactPage",
              ...
              "description": "Enterprise project consultation and requirements intake for ATIDETO Technologies",
              "mainEntity": {
                "@type": "Organization",
