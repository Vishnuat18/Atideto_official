...
export default function RequirementGathering() {
  ...
  const cardBg = isDark ? '#0A0F1C' : 'white';
  const selectBg = isDark ? '#0A0F1C' : '#F8FAFC';
  const selectText = (hasValue: boolean) => (isDark ? '#FFFFFF' : hasValue ? '#0F172A' : '#64748B');
  ...
  if (submitted) {
    return (
      <div style={{ background: pageBg, minHeight: '100vh', paddingTop: '80px' }} className="flex items-center justify-center">
        <div className="max-w-md mx-auto px-6 text-center">
          <div className="w-20 h-20 rounded-full bg-[#00D26A]/20 flex items-center justify-center text-4xl mx-auto mb-6">
            ✅
          </div>
          <h2 className="text-[#0F172A] text-2xl font-bold mb-4" >
            Requirements Submitted!
          </h2>
          <p className="text-[#64748B] mb-8">
            We've received your project requirements for <strong className="text-[#0F172A]">{form.service}</strong>. Our team will analyze your needs and reach out within 24 hours.
          </p>
    ...
    <div style={{ background: pageBg, minHeight: '100vh', paddingTop: '80px' }}>
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-4xl lg:text-6xl font-black text-[#0F172A] mb-4" style={{ letterSpacing: '-0.02em' }}>
        ...
        <div className="max-w-3xl mx-auto px-6">
          <form onSubmit={handleSubmit}>
            <div
              ...
              style={{ background: cardBg, border: '1px solid rgba(47,47,228,0.15)' }}
            >
              {/* Client Info */}
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="fullName" className="text-[#64748B] text-sm block mb-2">Full Name *</label>
                  ...
                  <div>
                    <label htmlFor="company" className="text-[#64748B] text-sm block mb-2">Company</label>
                  ...
                  <div>
                    <label htmlFor="email" className="text-[#64748B] text-sm block mb-2">Email *</label>
                  ...
                  <div>
                    <label htmlFor="phone" className="text-[#64748B] text-sm block mb-2">Phone</label>
              ...
              <div>
                ...
                <select
                  ...
                  required
                  style={{ background: selectBg, color: selectText(!!form.service) }}
                >
                  <option value="">Select a service</option>
                  {SERVICES.map((s) => (
                    <option key={s.id} value={s.title} style={{ background: optionBg }}>
                      {s.title}
                    </option>
                  ))}
                </select>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="description" className="text-[#64748B] text-sm block mb-2">Business Description *</label>
                    <textarea
                      id="description"
                      className="form-input"
                      rows={4}
                  ...
                  <div>
                    <label htmlFor="features" className="text-[#64748B] text-sm block mb-2">Required Features</label>
                    <textarea
                      id="features"
                      className="form-input"
                      rows={3}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="budget" className="text-[#64748B] text-sm block mb-2">Budget Range</label>
                    <select
                      id="budget"
                      className="form-input"
                      value={form.budget}
                      onChange={(e) => update('budget', e.target.value)}
                      style={{ background: selectBg, color: selectText(!!form.budget) }}
                    >
                      <option value="">Select budget</option>
                      {['Under $5K', '$5K–$15K', '$15K–$50K', '$50K–$150K', '$150K+', 'Not sure'].map((b) => (
                        <option key={b} value={b} style={{ background: optionBg }}>{b}</option>
                      ))}
                    </select>
                  </div>
                  <div>
                    <label htmlFor="timeline" className="text-[#64748B] text-sm block mb-2">Timeline</label>
                    <select
                      id="timeline"
                      className="form-input"
                      value={form.timeline}
                      onChange={(e) => update('timeline', e.target.value)}
                      style={{ background: selectBg, color: selectText(!!form.timeline) }}
                    >
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-[#64748B] text-xs mt-1">PDF, DOC, XLS, PNG up to 10MB</p>
                  <input
                    id="file-input"
                    type="file"
                    className="hidden"
