  ...
  const aboutSchema = {
    ...
    "@graph": [
      ...
      ]),
      {
        ...
        "description": "Learn about ATIDETO Technologies: founded and led by CEO Vishnu R, Founder Neevas Nagil, and CPO Kiran Patil. Engineering custom enterprise software, CRM, ERP, and AI systems in Salem, Tamil Nadu.",
  ...
  return (
    <div className="about-page min-h-screen relative overflow-x-clip font-sans selection:bg-[var(--about-primary)] selection:text-white">
      <SEO
        ...
        description="Discover ATIDETO Technologies: led by CEO & Founder Vishnu R, Founder Neevas Nagil, and CPO Kiran Patil in Salem, Tamil Nadu. Learn about our enterprise engineering culture, digital transformation, and business solutions."
        keywords="About ATIDETO Technologies, ATIDETO, Vishnu CEO, Vishnu R Atideto, Neevas Nagil Founder, Kiran CPO, software company Salem, custom software Salem, enterprise software Tamil Nadu, IT solutions India, CRM, ERP, AI automation"
        url="https://www.atideto.in/about"
