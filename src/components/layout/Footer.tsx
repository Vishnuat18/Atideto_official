    ...
    >
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-muted-foreground text-sm">
                ...
                <div className="flex flex-col">
                  <a href="tel:+919087284053" className="hover:text-primary transition-colors">+91 9087284053</a>
                  <a href="tel:+919363600534" className="hover:text-primary transition-colors text-xs text-muted-foreground/80">+91 9363600534</a>
                </div>
              </li>
              <li className="flex items-start gap-3 text-muted-foreground text-sm">
                <div className="w-7 h-7 rounded-full border border-border flex items-center justify-center shrink-0 mt-0.5">
                ...
                <a href="mailto:atidetotechnologies@gmail.com" className="mt-1 break-all hover:text-primary transition-colors">atidetotechnologies@gmail.com</a>
              </li>
      ...
      <div className="border-t border-border max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
          <p>© {new Date().getFullYear()} ATIDETO Technologies. All rights reserved. · Salem, Tamil Nadu, India</p>
          <span className="hidden sm:inline text-primary/40">•</span>
          <span className="font-semibold tracking-wider text-primary text-[11px] uppercase">INNOVATE • BUILD • TRANSFORM</span>
        </div>
